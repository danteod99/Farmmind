  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh", background: "#07070e" }}>
        ...
        {/* DEMO VIDEO */}
        <section className="tf-section" style={{ padding: "32px 20px 48px", background: "#08080f" }}>
          <div style={{ maxWidth: "900px", margin: "0 auto" }}>
            <div style={{ textAlign: "center", marginBottom: "20px" }}>
              <p style={{ fontSize: "11px", fontWeight: 700, color: FB_BLUE, textTransform: "uppercase", letterSpacing: "1.5px", marginBottom: "8px" }}>Demo · 3 min</p>
              <h2 style={{ fontSize: "clamp(22px, 4vw, 30px)", fontWeight: 800, color: "white", letterSpacing: "-0.02em" }}>
                TrustFace <span style={{ color: FB_BLUE }}>en acción</span>
              </h2>
            </div>
            <div style={{ position: "relative", paddingBottom: "56.25%", height: 0, borderRadius: "20px", overflow: "hidden", boxShadow: `0 24px 80px ${FB_BLUE}30` }}>
