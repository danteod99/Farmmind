...
const APPS = [
  {
    ...
    downloads: {
      mac: { label: "macOS (Apple Silicon)", size: "110 MB", url: "https://github.com/danteod99/trustmind-releases/releases/download/v1.6.9/TrustInsta-Desktop-1.6.9-arm64.dmg" },
      macIntel: { label: "macOS (Intel)", size: "Proximamente", url: "#" },
      windows: { label: "Windows x64", size: "89 MB", url: "https://github.com/danteod99/trustmind-releases/releases/download/v1.6.9/TrustInsta-Desktop-Setup-1.6.9.exe" },
    },
    version: "1.6.9",
  ...
  },
  {
    ...
    downloads: {
      mac: { label: "macOS (Apple Silicon)", size: "110 MB", url: "https://github.com/danteod99/trustface-releases/releases/download/v1.6.8/TrustFace-Desktop-1.6.8-arm64.dmg" },
      macIntel: { label: "macOS (Intel)", size: "Proximamente", url: "#" },
      windows: { label: "Windows x64", size: "89 MB", url: "https://github.com/danteod99/trustface-releases/releases/download/v1.6.8/TrustFace-Desktop-Setup-1.6.8.exe" },
    },
    version: "1.6.8",
    requirements: ["macOS 12+ o Windows 10+", "4 GB RAM minimo", "500 MB espacio en disco"],
  },
